...
public:
    ...
    explicit QxtConfigWidget(QWidget* parent = 0, Qt::WindowFlags flags = Qt::WindowFlags{});
    explicit QxtConfigWidget(QxtConfigWidget::IconPosition position, QWidget* parent = 0, Qt::WindowFlags flags = Qt::WindowFlags{});
