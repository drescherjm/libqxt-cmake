...
//    QDialogButtonBox* buttons = qFindChild<QDialogButtonBox*>(&qxt_p());
    QDialogButtonBox* buttons = qxt_p().findChild<QDialogButtonBox*>(); //qFindChild<QDialogButtonBox*>(&qxt_p());
    if (grid && buttons)
    {
...
//    QDialogButtonBox* buttonBox = qFindChild<QDialogButtonBox*>(&msgBox);
    QDialogButtonBox* buttonBox = msgBox.findChild<QDialogButtonBox*>(); //qFindChild<QDialogButtonBox*>(&msgBox);
