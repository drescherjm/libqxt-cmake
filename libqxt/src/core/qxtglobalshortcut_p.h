...
class QxtGlobalShortcutPrivateNativeEventFilter : public QAbstractNativeEventFilter{
public:
    QxtGlobalShortcutPrivateNativeEventFilter(){}
    ~QxtGlobalShortcutPrivateNativeEventFilter(){}
...
public:
    ...
    static void activateShortcut(quint32 nativeKey, quint32 nativeMods){
        event_filter.activateShortcut(nativeKey, nativeMods);
    }
private:
    ...
    static QxtGlobalShortcutPrivateNativeEventFilter event_filter;
